...
var base = Rebase.createClass({
  apiKey: "AIzaSyCmk_vZ19xfljToqgzK5TDYbPH8Ski2Z7A",   // replace with your Firebase application's API key
  databaseURL: "https://final-buyflix.firebaseio.com/", // replace with your Firebase application's database URL
})
    ...
    if (this.state.currentView === 'map') {
      return (
        ...
        {theatres.map(function(place) {
          return <Marker key={place.id} place={place} lat={place.lat} lng={place.long}/>
        })}
        </Gmaps>
      </div>
      )
